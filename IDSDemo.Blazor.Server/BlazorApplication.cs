...
namespace IDSDemo.Blazor.Server {
    public partial class IDSDemoBlazorApplication : BlazorApplication {
        public IDSDemoBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void IDSDemoBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
